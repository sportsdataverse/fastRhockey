#' @title PWHPA Standings and Team Stats
#' @description Returns team standings and stats
#' @return Returns a tibble
#' @keywords PWHPA Standings and Team Stats
#' @import httr
...
pwhpa_standings <- function() {
  ...
  tryCatch(
    ...
    error = function(e) {
      message(glue::glue("{Sys.time()}: Invalid arguments or no standings/team stats data available!"))
    },
    warning = function(w) {
    },
    finally = {
