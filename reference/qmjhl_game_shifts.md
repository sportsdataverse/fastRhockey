...
All player shift stints for a QMJHL game (one row per stint).

## Usage

``` r
qmjhl_game_shifts(game_id)
```
...
A `fastRhockey_data` data frame, one row per shift stint.
...
#> ℹ Data updated: 2026-06-09 20:30:38 UTC
#> # A tibble: 0 × 0
```
