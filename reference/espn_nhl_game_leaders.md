...
``` r
espn_nhl_game_leaders(event_id, cid = event_id, ...)
```
...
tibble with a warning. When populated:
...
#> ✖ 2026-06-12 02:19:40.607036: Invalid arguments or no ESPN nhl game leaders for event 401688263 available!
