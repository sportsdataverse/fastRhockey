...
function takes the fast path and hits `draft/picks/{year}/all` in a
single request instead of looping over rounds 1-7.
...
- round:
  ...
  Integer, character, or NULL. Specific round (1-7), the literal string
  `"all"`, or `NULL` (treated the same as `"all"`) to fetch every round
  at once.
...
#> ℹ Data updated: 2026-05-29 18:46:01 UTC
#> # A tibble: 32 × 20
...
#> ── NHL Draft Year data from NHL.com ─────────────────────── fastRhockey 1.0.0 ──
#> ℹ Data updated: 2026-05-29 18:46:02 UTC
#> # A tibble: 223 × 20
#>    round pick_in_round overall_pick team_id team_abbrev team_name$default  $fr  
#>    <int>         <int>        <int>   <int> <chr>       <chr>              <chr>
#>  1     1             1            1      16 CHI         Chicago Blackhawks Blac…
