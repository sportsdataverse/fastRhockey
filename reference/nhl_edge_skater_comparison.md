...
Returns the NHL Edge skater comparison payload for a single focus player
versus a cohort. Wraps
...
``` r
nhl_edge_skater_comparison(player_id, season = NULL, game_type = 2)
```
...
A `fastRhockey_data` tibble comparing the focus player against the
...
#> ℹ Data updated: 2026-04-13 17:04:44 UTC
#> # A tibble: 5 × 2
#>         id game_types
#>      <int> <list>    
#> 1 20212022 <int [2]> 
