...
#> 1 401688263 401688263 s:70~l:9… 2025… Chic… CHI @ DET  TRUE       401688263     
#> # ℹ 6 more variables: competition_ref <chr>, venue_ref <chr>, season_ref <chr>,
#> #   season_type_ref <chr>, league_ref <chr>, event_ref <chr>
# }
```
