...
Functions exported by fastRhockey sourced from the game endpoint of the
NHL API
...
Functions exported by fastRhockey sourced from the teams endpoint of the
NHL API
...
- [`nhl_teams_info()`](https://fastRhockey.sportsdataverse.org/reference/nhl_teams_info.md)
  :
...
- [`nhl_teams_stats()`](https://fastRhockey.sportsdataverse.org/reference/nhl_teams_stats.md)
  :

  **NHL Teams Stats**

- [`nhl_team_prospects()`](https://fastRhockey.sportsdataverse.org/reference/nhl_team_prospects.md)
  :

  **NHL Team Prospects**

- [`nhl_team_scoreboard()`](https://fastRhockey.sportsdataverse.org/reference/nhl_team_scoreboard.md)
  :
...
- [`nhl_club_stats_season()`](https://fastRhockey.sportsdataverse.org/reference/nhl_club_stats_season.md)
  :
...
Functions exported by fastRhockey sourced from the players endpoint of
the NHL API
...
- [`nhl_player_spotlight()`](https://fastRhockey.sportsdataverse.org/reference/nhl_player_spotlight.md)
  :
...
- [`nhl_roster_season()`](https://fastRhockey.sportsdataverse.org/reference/nhl_roster_season.md)
  :
...
Functions exported by fastRhockey sourced from the schedule endpoint of
the NHL API
...
- [`nhl_schedule_calendar()`](https://fastRhockey.sportsdataverse.org/reference/nhl_schedule_calendar.md)
  :
...
Functions exported by fastRhockey sourced from the draft endpoint of the
NHL API
...
- [`nhl_draft_prospects()`](https://fastRhockey.sportsdataverse.org/reference/nhl_draft_prospects.md)
  :

  **NHL Draft Prospects**

- [`nhl_draft_prospects_info()`](https://fastRhockey.sportsdataverse.org/reference/nhl_draft_prospects_info.md)
  :

  **NHL Draft Prospects Info**

- [`nhl_draft_rankings()`](https://fastRhockey.sportsdataverse.org/reference/nhl_draft_rankings.md)
  :
...
Functions exported by fastRhockey sourced from the standings endpoint of
the NHL API
...
- [`nhl_standings_season()`](https://fastRhockey.sportsdataverse.org/reference/nhl_standings_season.md)
  :
...
Functions exported by fastRhockey for NHL season metadata and aggregated
stats
...
- [`nhl_skater_stats_leaders()`](https://fastRhockey.sportsdataverse.org/reference/nhl_skater_stats_leaders.md)
  :

  **NHL Skater Stats Leaders**

- [`nhl_goalie_stats_leaders()`](https://fastRhockey.sportsdataverse.org/reference/nhl_goalie_stats_leaders.md)
  :
...
Functions exported by fastRhockey sourced from the conferences and
divisions endpoints of the NHL API

- [`nhl_conferences()`](https://fastRhockey.sportsdataverse.org/reference/nhl_conferences.md)
  :

  **NHL Conferences**

- [`nhl_conferences_info()`](https://fastRhockey.sportsdataverse.org/reference/nhl_conferences_info.md)
  :

  **NHL Conference Info**

- [`nhl_divisions()`](https://fastRhockey.sportsdataverse.org/reference/nhl_divisions.md)
  :

  **NHL Divisions**

- [`nhl_divisions_info()`](https://fastRhockey.sportsdataverse.org/reference/nhl_divisions_info.md)
  :
...
- [`nhl_location()`](https://fastRhockey.sportsdataverse.org/reference/nhl_location.md)
  :
...
Functions exported by fastRhockey which update and create a database of
fastRhockey NHL play-by-play data
...
- [`csv_from_url()`](https://fastRhockey.sportsdataverse.org/reference/csv_from_url.md)
  :

  **Load .csv / .csv.gz file from a remote connection**

- [`progressively()`](https://fastRhockey.sportsdataverse.org/reference/progressively.md)
  :

  **Progressively**

- [`rds_from_url()`](https://fastRhockey.sportsdataverse.org/reference/rds_from_url.md)
  :
...
Data loaders for the defunct PHF league. Historical data may still be
available but is no longer updated.
