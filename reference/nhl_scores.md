...
#> ℹ Data updated: 2026-06-12 02:23:02 UTC
#> # A tibble: 1 × 46
#>           id   season game_type game_date  start_time_utc     eastern_utc_offset
#>        <int>    <int>     <int> <chr>      <chr>              <chr>             
#> 1 2025030415 20252026         3 2026-06-11 2026-06-12T00:00:… -04:00            
#> # ℹ 40 more variables: venue_utc_offset <chr>, tv_broadcasts <list>,
#> #   game_state <chr>, game_schedule_state <chr>, game_center_link <chr>,
#> #   series_url <chr>, neutral_site <lgl>, venue_timezone <chr>, period <int>,
#> #   goals <list>, venue_default <chr>, away_team_id <int>,
#> #   away_team_abbrev <chr>, away_team_score <int>, away_team_sog <int>,
#> #   away_team_logo <chr>, away_team_name_default <chr>, home_team_id <int>,
#> #   home_team_abbrev <chr>, home_team_score <int>, home_team_sog <int>, …
# }
```
