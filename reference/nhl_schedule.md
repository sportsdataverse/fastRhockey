...
#> ℹ Data updated: 2026-05-29 18:27:47 UTC
#> # A tibble: 53 × 13
...
#> ── NHL Schedule ─────────────────────────────────────────── fastRhockey 1.0.0 ──
#> ℹ Data updated: 2026-05-29 18:27:49 UTC
#> # A tibble: 95 × 16
#>       game_id season_full game_type game_date  game_time          home_team_abbr
#>         <int> <chr>       <chr>     <chr>      <chr>              <chr>         
...
#> 2026-05-29 18:27:50.507218: Error fetching schedule for 2024-01-15: `x` and `y` must share the same src.
# }
```
