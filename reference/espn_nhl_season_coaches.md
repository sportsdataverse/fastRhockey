...
``` r
espn_nhl_season_coaches(season = most_recent_nhl_season(), limit = 100, ...)
```
...
- limit:
  ...
  Maximum number of coaches to return (default `100`). The NHL typically
  lists ~30 head coaches per season.
...
#> ℹ Data updated: 2026-06-13 02:47:25 UTC
#> # A tibble: 30 × 5
