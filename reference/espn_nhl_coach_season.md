...
``` r
espn_nhl_coach_season(coach_id, season = most_recent_nhl_season(), ...)
```
...
#> 1 900        2026 900     s:70~l:… Marco      Sturm     1978-09-08T0… NA        
#> # ℹ 2 more variables: birth_country <chr>, person_ref <chr>
# }
```
