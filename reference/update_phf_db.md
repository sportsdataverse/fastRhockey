...
update_phf_db() updates or creates a database with `fastRhockey` play by
play data of all completed and available games since 2011.
...
data for every available game back to the 2016 season and adds the most
...
by play data table either for the whole fastRhockey era (with
