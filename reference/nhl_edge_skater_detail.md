...
skater. Wraps
`https://api-web.nhle.com/v1/edge/skater-detail/{playerId}/...`. When
...
``` r
nhl_edge_skater_detail(player_id, season = NULL, game_type = 2)
```
...
#> ℹ Data updated: 2026-05-29 18:46:18 UTC
#> # A tibble: 5 × 2
#>         id game_types
#>      <int> <list>    
#> 1 20212022 <int [2]> 
