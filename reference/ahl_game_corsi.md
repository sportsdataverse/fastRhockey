...
Player-level on-ice Corsi and Fenwick for an AHL game.

## Usage

``` r
ahl_game_corsi(game_id)
```
...
#> ✖ 2026-06-13 04:18:10.498576: AHL game Corsi for game_id 1000093924 unavailable! Error in `$<-.data.frame`(`*tmp*`, "game_date", value = ""): replacement has 1 row, data has 0
