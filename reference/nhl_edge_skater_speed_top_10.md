...
Returns the NHL Edge top-10 "fastest skaters" leaderboard for a given
...
``` r
nhl_edge_skater_speed_top_10(positions, sort_by, season = NULL, game_type = 2)
```
...
#> 2026-04-13 17:05:00.198638: Error fetching https://api-web.nhle.com/v1/edge/skater-speed-top-10/F/total/now: The API returned an error
#> NULL
# }
```
