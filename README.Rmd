...
You can view CSVs of historical boxscore and play-by-play on the [**`fastRhockey`**](https://github.com/BenHowell71/fastRhockey/) [data repo](https://github.com/benhowell71/fastRhockey-data), as well as the process for scraping that historical data.
