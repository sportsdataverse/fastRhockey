...
<!-- badges: start -->
[![CRAN status](https://www.r-pkg.org/badges/version-last-release/cfbfastR?style=for-the-badge)](https://CRAN.R-project.org/package=fastRhockey)
...
You can install the CRAN version of [**```fastRhockey```** ](https://cran.r-project.org/web/packages/fastRhockey/index.html) with:
```r
