...
You can install the released version of [**`whockeyR`**](https://github.com/BenHowell71/whockey_scraper/) from [GitHub](https://github.com/BenHowell71/whockey_scraper) with:
...
[![GitHub stars](https://img.shields.io/github/stars/BenHowell71/whockey_scraper.svg?color=eee&logo=github&style=for-the-badge&label=Star%20whockeyR&maxAge=2592000)](https://github.com/BenHowell71/whockey_scraper/stargazers/)
...
To cite the [**`whockeyR`**](https://benhowell71.github.io/whockey_scraper/) R package in publications, use:
