...
![](logo/fastRhockey full holographic graphic.png){width=50%}
...
If you look with `fastRhockey::`, there are more functions available, but those are helper functions to pull raw data (`phf_game_data`) and then to process the raw data into a usable format (`process____`). 
